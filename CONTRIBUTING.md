...
* File issues/questions on Github: [https://github.com/Pocket/front-end-build-tools/issues](https://github.com/Pocket/front-end-build-tools/issues). We typically triage new issues every Monday.
...
Please review the [README](https://github.com/Pocket/front-end-build-tools/blob/master/README.md) for instructions on setting up your development environment, installing dependencies and building the extensions.
